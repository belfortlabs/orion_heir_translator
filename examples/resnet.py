...
def run_orion_resnet_demo():
    ...
    try:
        ...
        operations = (
            frontend.create_mlp_operations() if hasattr(frontend, "create_mlp_operations") else []
        )
    ...
    try:
        ...
        module = translator.translate(operations, scheme_params, function_name="resnet10")
